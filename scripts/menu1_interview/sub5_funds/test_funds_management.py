...
class TestFundsManagement:
    ...
    def test_add(self, text, num):
        ...
        time.sleep(1)
        self.page.input_text(path='采访-资金管理-新增/编辑-输入框', content=text, param='资金名称', itype="clickinput")
        time.sleep(1)
        self.page.input_text(path='采访-资金管理-新增/编辑-输入框', content=num, param='金额', itype="clickinput")
